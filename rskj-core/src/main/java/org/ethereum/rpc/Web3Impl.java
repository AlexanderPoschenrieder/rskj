...
public class Web3Impl implements Web3 {
    ...
    public Web3Impl(SolidityCompiler compiler, Wallet wallet, Ethereum eth) {
        ...
        this.wallet = wallet;
        this.eth = eth;
        this.personalModule = new PersonalModuleWithWallet(eth, wallet);
    }

    protected Web3Impl(Ethereum eth, RskSystemProperties properties, Wallet wallet, PersonalModule personalModule, EthModule ethModule) {
        this.eth = eth;
