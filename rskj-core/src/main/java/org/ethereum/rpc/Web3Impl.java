...
public class Web3Impl implements Web3 {
    ...
    public Web3Impl(Ethereum eth, RskSystemProperties properties, Wallet wallet) {
        this(eth, properties, wallet, new PersonalModule(eth, wallet));
    }

    private Web3Impl(Ethereum eth, RskSystemProperties properties, Wallet wallet, PersonalModule personalModule) {
        this.eth = eth;
