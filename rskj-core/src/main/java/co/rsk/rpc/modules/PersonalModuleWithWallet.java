...
public class PersonalModuleWithWallet implements PersonalModule {
    ...
    public PersonalModuleWithWallet(Ethereum eth, Wallet wallet) {
        this.eth = eth;
        this.wallet = wallet;
    }
    ...
    public void init(RskSystemProperties properties) {
        ...
        for (WalletAccount acc : accs) {
            wallet.addAccountWithPrivateKey(Hex.decode(acc.getPrivateKey()));
        }
    }
